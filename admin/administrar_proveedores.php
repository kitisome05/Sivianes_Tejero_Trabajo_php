        ...
        <?php
          ...
          <?php
            ...
            if (isset($_SESSION['roll']) && $_SESSION['roll']=='admin') {
              ...
              <a href='añadir_proveedor.php'><button type="button">Añadir nuevo proveedor</button></a>
...
<thead>
  <tr><h2>Administración de proveedores</h2></tr>
  <tr>
    <th>Nombre</th>
    <th>Acción</th>
</thead>
...
while($obj = $result->fetch_object()) {
    ...
    echo "<tr>";
      ...
      echo
          "<td>";
              echo "  <a href='editarproveedores.php?cod_proveedor=".$obj->cod_proveedor."'>
              <img src='/Sivianes_Tejero_Trabajo_php/imagenes/iconos/2.png' id='icono'></a>";
              echo "<a href='borrar_proveedor.php?cod_proveedor=".$obj->cod_proveedor."'><img src='/Sivianes_Tejero_Trabajo_php/imagenes/iconos/3.png' id='icono'></a>";
